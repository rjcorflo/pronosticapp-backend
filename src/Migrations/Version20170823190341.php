 ...
 */
class Version20170823190341 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__communities AS SELECT id, image_id, name, password, private, created, updated FROM communities');
        ...
        $this->addSql('INSERT INTO communities (id, image_id, name, password, private, created, updated) SELECT id, image_id, name, password, private, created, updated FROM __temp__communities');
        ...
        $this->addSql('CREATE TABLE participants (id INTEGER NOT NULL, player_id INTEGER DEFAULT NULL, community_id INTEGER DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_7169709299E6F5DF FOREIGN KEY (player_id) REFERENCES players (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_71697092FDA7B0BF FOREIGN KEY (community_id) REFERENCES communities (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__competitions AS SELECT id, image_id, name, alias, color FROM competitions');
        $this->addSql('DROP TABLE competitions');
        $this->addSql('CREATE TABLE competitions (id INTEGER NOT NULL, image_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, alias VARCHAR(255) NOT NULL COLLATE BINARY, color VARCHAR(255) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_A7DD463D3DA5256D FOREIGN KEY (image_id) REFERENCES images (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO competitions (id, image_id, name, alias, color) SELECT id, image_id, name, alias, color FROM __temp__competitions');
        ...
        $this->addSql('CREATE TABLE forecasts (id INTEGER NOT NULL, player_id INTEGER DEFAULT NULL, community_id INTEGER DEFAULT NULL, match_id INTEGER DEFAULT NULL, local_goals INTEGER NOT NULL, away_goals INTEGER NOT NULL, risk BOOLEAN NOT NULL, points INTEGER NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_6A95D6FA99E6F5DF FOREIGN KEY (player_id) REFERENCES players (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6A95D6FAFDA7B0BF FOREIGN KEY (community_id) REFERENCES communities (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6A95D6FA2ABEACD6 FOREIGN KEY (match_id) REFERENCES matches (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__stadiums AS SELECT id, image_id, name, color, city FROM stadiums');
        $this->addSql('DROP TABLE stadiums');
        $this->addSql('CREATE TABLE stadiums (id INTEGER NOT NULL, image_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, color VARCHAR(255) DEFAULT NULL COLLATE BINARY, city VARCHAR(255) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_FD8B970E3DA5256D FOREIGN KEY (image_id) REFERENCES images (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO stadiums (id, image_id, name, color, city) SELECT id, image_id, name, color, city FROM __temp__stadiums');
        ...
        $this->addSql('CREATE TABLE tokens (id INTEGER NOT NULL, player_id INTEGER DEFAULT NULL, token_string VARCHAR(255) NOT NULL COLLATE BINARY, expire_at DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_AA5A118E99E6F5DF FOREIGN KEY (player_id) REFERENCES players (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__communities AS SELECT id, image_id, name, password, private, created, updated FROM communities');
        $this->addSql('DROP TABLE communities');
        $this->addSql('CREATE TABLE communities (id INTEGER NOT NULL, image_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, private BOOLEAN NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO communities (id, image_id, name, password, private, created, updated) SELECT id, image_id, name, password, private, created, updated FROM __temp__communities');
        $this->addSql('DROP TABLE __temp__communities');
        $this->addSql('CREATE INDEX IDX_ECE312B3DA5256D ON communities (image_id)');
        $this->addSql('DROP INDEX IDX_A7DD463D3DA5256D');
        $this->addSql('CREATE TEMPORARY TABLE __temp__competitions AS SELECT id, image_id, name, alias, color FROM competitions');
        $this->addSql('DROP TABLE competitions');
        $this->addSql('CREATE TABLE competitions (id INTEGER NOT NULL, image_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, alias VARCHAR(255) NOT NULL, color VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO competitions (id, image_id, name, alias, color) SELECT id, image_id, name, alias, color FROM __temp__competitions');
        $this->addSql('DROP TABLE __temp__competitions');
        $this->addSql('CREATE INDEX IDX_A7DD463D3DA5256D ON competitions (image_id)');
        $this->addSql('DROP INDEX IDX_6A95D6FA99E6F5DF');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__stadiums AS SELECT id, image_id, name, color, city FROM stadiums');
        $this->addSql('DROP TABLE stadiums');
        $this->addSql('CREATE TABLE stadiums (id INTEGER NOT NULL, image_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO stadiums (id, image_id, name, color, city) SELECT id, image_id, name, color, city FROM __temp__stadiums');
        $this->addSql('DROP TABLE __temp__stadiums');
        $this->addSql('CREATE INDEX IDX_FD8B970E3DA5256D ON stadiums (image_id)');
        $this->addSql('DROP INDEX IDX_96C222587E860E36');
