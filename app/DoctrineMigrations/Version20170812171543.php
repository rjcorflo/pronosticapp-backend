 ...
 */
class Version20170812171543 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('INSERT INTO stadiums (id, image_id, name, color) SELECT id, image_id, name, color FROM __temp__stadiums');
